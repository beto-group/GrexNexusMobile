...
public class CurrencyWidgetProvider extends AppWidgetProvider {
    ...
    public static final String ACTION_CYCLE_PAIR = "group.beto.grexnexus.child.CYCLE_PAIR";
    public static final String ACTION_CYCLE_AMOUNT = "group.beto.grexnexus.child.CYCLE_AMOUNT";
    public static final String ACTION_TOGGLE_DIRECTION = "group.beto.grexnexus.child.TOGGLE_DIRECTION";

    private static int pairIndex = 0;
    private static int amountIndex = 1;
    ...
    public static void updateAppWidget(Context context, AppWidgetManager appWidgetManager, int appWidgetId) {
        ...
        String rateStr = String.format(Locale.US, "%s ➔ %s @ %.2f", fromCurr, toCurr, isReversed ? (1.0 / pair.rate) : pair.rate);
